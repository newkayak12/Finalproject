...
.foodView-info-container table tr th {
	color: #2AC1BC;
	font-family: twayair;
	width: 15%;
	min-width: 100px;
...
.foodView-info-container table tr td {
	color: black;
	width: 85%;
}
...
.foodView-icons-inner:hover {
	font-weight: 500 !important;
	color: #2AC1BC !important;
	cursor: pointer;
}

.foodView-icons-inner a {
	text-decoration: none;
...
<<<<<<< HEAD
						<span class="tway " style="font-size: 40px;"><c:out
							...
							style="font-size: 40px; font-weight: 900;"><c:out
								value="${ food.foodStar }" /></span> <br> <span class="lightgray"><i
							class="fas fa-eye lightgray"></i>&nbsp;<c:out
								value="${ food.foodLikeCount }" /></span>&nbsp;&nbsp; <span
							class="lightgray"><i class="fas fa-pencil-alt lightgray"></i>&nbsp;<c:out
...
>>>>>>> 77db014987f05f94fa73b5e475e656a95a9547b2
								...
								<span style="font-size: 15px; font-weight: 900;"
									id="likecontent" style="color : #2AC1BC !important;">가고싶다</span>
							</div>
						</c:if>
...
>>>>>>> 77db014987f05f94fa73b5e475e656a95a9547b2
								...
								<span style="font-size: 15px; font-weight: 900;"
									id="unlikecontent" style="color : lightgray !important;">가고싶다</span>
							</div>
						</c:if>
						...
						<c:if test="${ food.foodCategoryMain != '카페/디저트' }">
							...
							<div class="foodView-icons-inner mr-3">
								<a
									href="${ path }/food/foodBooking/start?foodSeq=${ food.foodSeq }">
									<div class="foodView-icon-style">
										<i class="far fa-calendar-check"></i>
									</div> <span style="font-size: 15px; font-weight: 900;">예약하기</span>
								</a>
							</div>
						</c:if>
						...
						<div class="foodView-icons-inner mr-3">
							<a
								href="${ path }/food/foodReview/start?foodSeq=${ food.foodSeq }">
								<div class="foodView-icon-style">
									<i class="fas fa-pencil-alt"></i>
								</div> <span style="font-size: 15px; font-weight: 900;">리뷰쓰기</span>
							</a>
						</div>
					</div>
				...
				<div class="foodView-info-container">
					...
					<table>
						...
						<tr>
							<th class="">음식 종류</th>
							<td class=""><c:out value="${ food.foodCategoryMain }" /> |
								<c:out value="${ food.foodCategorySub }" /></td>
						</tr>
						<tr>
							<th class="">가격대</th>
							<td class=""><c:choose>
									...
									<c:when
										test="${ food.foodPrice ge 10000 and food.foodPrice lt 20000 }">1만원 - 2만원</c:when>
									<c:when
										test="${ food.foodPrice ge 20000 and food.foodPrice lt 30000  }">2만원 - 3만원</c:when>
						...
						<tr>
							<th class="">영업시간</th>
							<td class=""><c:out
									value="${ food.foodTimeFirst} - ${ food.foodTimeLast }" /></td>
						</tr>
						<c:if test="${fn:length(food.foodUrl) gt 15 }">
							<tr>
								<th class="">웹사이트</th>
								<td class=""><a class="atag" href="${ food.foodUrl }"
									target="_blank">맛집 홈페이지로 가기</a></td>
							</tr>
						</c:if>
						<tr>
							<th class="">식당 소개</th>
